...
class Shishimaru : ICharacterObject {

    private val VELOCITY_DASH = 10f
    private val VELOCITY_SLOW = 4.0f
    ...
    override var image: TextureRegion = Assets.runAnimationShishimaru.getKeyFrame(stateTime, true)
        get() = Assets.runAnimationShishimaru.getKeyFrame(stateTime, true)
        private set
